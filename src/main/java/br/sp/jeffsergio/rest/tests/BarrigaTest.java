package br.sp.jeffsergio.rest.tests;
...
public class BarrigaTest extends BaseTests {
	...
	public void t03_deveAlterarContaComSucesso() {
		...
		given()
			.body("{ \"nome\" : \""+ CONTA_NAME + " altered\"}")
			.pathParam("id", CONTA_ID)
		.when()
			.put("/contas/{id}")
		.then()
			.statusCode(200)
			.body("nome", is(CONTA_NAME + " altered"))
		;
	}
	...
	@Test
	public void t08_naoDeveRemoverMovimentacao() {
